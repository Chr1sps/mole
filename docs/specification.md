...
SIMPLE_TYPE = [REF_SPECIFIER], BUILT_IN_TYPE;
...
LITERAL_EXPR = U32_EXPR |
             F64_EXPR |
             STRING_EXPR |
             CHAR_EXPR |
             BOOL_EXPR ;
BASE_EXPR = PAREN_EXPR | LITERAL_EXPR;
...
INDEX_LAMBDA_OR_CALL = BASE_EXPR, {CALL_PART | LAMBDA_CALL_PART | INDEX_PART};
...
MATCH_ARM = LITERAL_ARM | GUARD_ARM | PLACEHOLDER_ARM;
...
<!-- MATCH_CASE = LITERAL_CASE | GUARD_CASE | PLACEHOLDER; -->
LITERAL_CONDITION = LITERAL_PATTERN, {BIT_OR, LITERAL_PATTERN};
LITERAL_PATTERN = [MINUS], U32_EXPR |
          [MINUS], F64_EXPR |
          STRING_EXPR |
          CHAR_EXPR;
