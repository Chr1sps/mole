...
#define GLOBALS(...) std::vector<std::unique_ptr<VarDeclStmt>>(__VA_ARGS__)
#define FUNCTIONS(...) std::vector<std::unique_ptr<FuncDefStmt>>(__VA_ARGS__)
#define EXTERNS(...) std::vector<std::unique_ptr<ExternStmt>>(__VA_ARGS__)
